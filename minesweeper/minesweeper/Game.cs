...
namespace minesweeper
{
    ...
    class Game
    {
        ...
        public Game()
        {
            ...
            gameOver = new Sprite(new Texture("Assets/Lose.png"));
            youWon = new Sprite(new Texture("Assets/Win.png"));

            gameOver.Position = new Vector2f(-20, 160 - 25);
            youWon.Position = new Vector2f(-20, 160 - 25);
        }
